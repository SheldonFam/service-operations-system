...
export function OrderActions({ order, userRole, onUpdated }: OrderActionsProps) {
  ...
  const showAssign = userRole === 'admin' && (order.status === 'new' || order.status === 'postponed')
  ...
  const showComplete = userRole === 'technician' && order.status === 'in_progress'
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction onClick={() => handleStatusUpdate('closed', 'Order closed successfully')}>
                Close Order
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
      ...
      {showReview && (
        <AlertDialog>
          ...
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              <AlertDialogCancel>Cancel</AlertDialogCancel>
              <AlertDialogAction onClick={() => handleStatusUpdate('reviewed', 'Order marked as reviewed')}>
                Confirm
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
