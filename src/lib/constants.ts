import { Sparkles, UserCheck, Wrench, PauseCircle, CircleCheck, ShieldCheck, Lock, type LucideIcon } from 'lucide-react'
import type { OrderStatus, PaymentMethod, ServiceType } from './types'

export const SERVICE_TYPES: ServiceType[] = ['Cleaning', 'Repair', 'Installation', 'Gas Refill', 'Inspection']
...
export const STATUS_FLOW: OrderStatus[] = ['new', 'assigned', 'in_progress', 'job_done', 'reviewed', 'closed']
...
export const STATUS_CONFIG: Record<OrderStatus, { label: string; className: string; icon: LucideIcon }> = {
  new: {
    label: 'New',
...
export const PAYMENT_METHODS: PaymentMethod[] = ['Cash', 'Bank Transfer', 'Card', 'E-Wallet']
